    ...
    <table class="rounded  border-collapse border border-slate-500 w-full">
        ...
        <tbody>
            ...
            odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                class="bg-green-600 rounded p-2 mx-1 w-2/3 text-center">{{__("view")}}</a>
                <a href="/{{$type}}/edit/{{ $row->id }}" 
                class="bg-blue-600 rounded p-2 mx-1 w-2/3 text-center">{{__('edit')}}</a>
            ...
            @empty
            <tr>
                <td class="text-center p-5">{{__('no '.$type.' yet :(')}}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
